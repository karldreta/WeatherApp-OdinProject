...
export async function fetchLocation(e) {
    ...
    const fetchWeatherReport = await fetch(`https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/${locationValue}/${dateToday}/${dateEnd}?key=3BZCY9DLAUZ38XRC8GGN95VYW`)
    ...
    return {currentWeek, descriptionWeek, timezone, address};
}
